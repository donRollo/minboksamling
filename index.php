...
<html>
	<head>
		...
		<link rel='stylesheet' id='' href='css/swiper.min.css' type='text/css' media='all' />
		<link rel='stylesheet' id='' href='css/swiper.design.css' type='text/css' media='all' />
...
<body class="">
	...
	<!-- SWIPER -->
	<div id="myBlurID" class="container mx-auto" style="padding-top: 70px;">
		<div class="grid grid-cols-1">
			<div class="swiper-container" style="background-color:#333333;max-width:1120px; border-top: 2px solid grey; border-bottom: 2px solid grey;">
			    <div class="swiper-wrapper">
			        <div class="swiper-slide" style="height:320px;background-image:url(img/151_001_F.jpg);background-repeat: no-repeat;background-size:200px;"></div>
			        <div class="swiper-slide" style="height:320px;background-image:url(img/151_002_F.jpg);background-repeat: no-repeat;background-size:200px;"></div>
			        <div class="swiper-slide" style="height:320px;background-image:url(img/215_001_F.jpg);background-repeat: no-repeat;background-size:200px;"></div>
			        <div class="swiper-slide" style="height:320px;background-image:url(img/215_002_F.jpg);background-repeat: no-repeat;background-size:200px;"></div>
			        <div class="swiper-slide" style="height:320px;background-image:url(img/215_003_F.jpg);background-repeat: no-repeat;background-size:200px;"></div>
			        <div class="swiper-slide" style="height:320px;background-image:url(img/215_004_F.jpg);background-repeat: no-repeat;background-size:200px;"></div>
			        <div class="swiper-slide" style="height:320px;background-image:url(img/215_005_F.jpg);background-repeat: no-repeat;background-size:200px;"></div>
			        <div class="swiper-slide" style="height:320px;background-image:url(img/215_006_F.jpg);background-repeat: no-repeat;background-size:200px;"></div>
			    </div>
